---
name: Use WhatsApp
description: Send WhatsApp messages or search/sync history (not for normal chats)
homepage: https://wacli.sh
compatibility: see metadata.clawdbot.requires
metadata:
  author: Clawdbot
  clawdbot: {"emoji":"📱","requires":{"bins":["wacli"]},"install":[{"id":"go","kind":"go","module":"github.com/steipete/wacli/cmd/wacli@latest","bins":["wacli"],"label":"Install wacli (go)"}]}
---
